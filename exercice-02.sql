...
Insert into tag (name, description) values ('SASS', 'aucune');
...
Insert into student_tag (student_id, tag_id) values (1, 7);
...
WHERE student_id = 2 AND tag_id = 8;
...
WHERE student_id = 3 AND project_id = 3;
